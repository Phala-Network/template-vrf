...
async function main() {
  ...
  const finalMessage = dedent`
    ...
    Check it out here:
    - https://polygonscan.com/address/${vrfOracle.address} 
    - https://polygonscan.com/address/${vrfConsumer.address}
    ...
    npx @phala/fn upload -b --mode prod --consumerAddress=${vrfOracle.address}
    
    You also need to set up the consumer contract address in your .env file:
    
    POLYGON_CONSUMER_CONTRACT_ADDRESS=${vrfConsumer.address}
    POLYGON_VRF_ORACLE_CONTRACT_ADDRESS=${vrfOracle.address}
  `
  console.log(`\n${finalMessage}\n`);
  console.log('Done');
}
